 ...
 * @generated
 */
public class MessageAsyncEditPart extends AbstractMessageEditPart implements ITreeBranchEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MessageAsyncNameEditPart) {
			((MessageAsyncNameEditPart) childEditPart).setLabel(getPrimaryShape().getMessageLabelFigure());
		}
