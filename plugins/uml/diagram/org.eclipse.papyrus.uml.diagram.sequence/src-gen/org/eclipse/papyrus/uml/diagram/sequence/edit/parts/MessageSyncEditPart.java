 ...
 * @generated
 */
public class MessageSyncEditPart extends AbstractMessageEditPart implements ITreeBranchEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MessageSyncNameEditPart) {
			((MessageSyncNameEditPart) childEditPart).setLabel(getPrimaryShape().getMessageLabelFigure());
		}
