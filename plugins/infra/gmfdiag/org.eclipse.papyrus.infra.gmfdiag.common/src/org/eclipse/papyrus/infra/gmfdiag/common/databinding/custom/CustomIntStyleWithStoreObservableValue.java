...
public class CustomIntStyleWithStoreObservableValue extends CustomIntStyleObservableValue {
	 ...
	 */
	public CustomIntStyleWithStoreObservableValue(final View source, final EditingDomain domain, final String styleName, final IPreferenceStore preferenceStore) {
	...
	public void addToPreferenceStore(final Object value) {
		if (value instanceof Integer) {
			this.preferenceStore.setValue(this.styleName, ((Integer) value).intValue());
		}
	}
	...
	protected Integer getDefaultValue() {
		return this.preferenceStore.getInt(this.styleName);
	}
